export function Chip({ status }: { status: string }) {
  const map: Record<string, { label: string; cls: string }> = {
    ...
    'Новый проект': { label: 'Новый проект', cls: 'bg-slate-100 text-slate-700 ring-1 ring-slate-300' },
    ...
    'Завершен': { label: 'Завершен', cls: 'bg-slate-200 text-slate-800 ring-1 ring-slate-400' },
    ...
    'На приходе': { label: 'На приходе', cls: 'bg-teal-50 text-teal-700 ring-1 ring-teal-300' },
    ...
    'Ожидание клиента': { label: 'Ожидание клиента', cls: 'bg-pink-50 text-pink-700 ring-1 ring-pink-300' },
